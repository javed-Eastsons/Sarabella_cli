                ...
                ? scheduleList.map((value) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <View style={styles.viewInfo}><Text style={styles.textInfo}>Order Status</Text><Text style={{color:'#000'}}>: {value.Order_status!=null?value.Order_status:'Yet to start'}</Text></View>
